...
/*
  ...
  load more
*/
export default class ConsultantProfileCard extends React.Component {
    ...
    return (
        <View style={styles.container}>
          <Card style={styles.card}
              ...
              Type of Consultant: {this.state.typeConsultant}
              </Text>
              <Text style={styles.textStyles}>
              ...
              <Text style={styles.textStyles}>
              Years as Consultant: {this.state.yearsConsultant}
              </Text>
              </Card>

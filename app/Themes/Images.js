const images = {
  ...
  publicStorage: require('../Images/publicStorageLogo.png'),
  extraSpaceStorage: require('../Images/extraSpaceStorageLogo.png'),
  twoMenMoving: require('../Images/twoMenAndTruckLogo.png'),
